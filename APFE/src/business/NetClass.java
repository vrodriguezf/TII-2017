...
public class NetClass {
    ...
    public String generateNetSource() {
        ...
        this.netSource.append("import APFE.WFnet_OP.WFNetOP;").append(EOL);
        this.netSource.append("import APFE.guard_conditions.*;").append(EOL);
        this.netSource.append("import APFE.data_log.LogEntry;").append(EOL);
        this.netSource.append("import static APFE.guard_conditions.LogicalGuardCondition.LogicalExpression;").append(EOL);
        ...
        if (!Global.petriNet.getImplementText().isEmpty()) {
            this.netSource.append("public class ").append(Global.petriNet.getLabel()).append(" extends WFNetOP implements ").append(Global.petriNet.getImplementText()).append(" {").append(EOL).append(EOL);
        } else {
            //this.netSource.append("public class ").append(Global.petriNet.getLabel()).append(" extends PetriNet {").append(EOL);
            this.netSource.append("public class ").append(Global.petriNet.getLabel()).append(" extends WFNetOP {").append(EOL);
        }
