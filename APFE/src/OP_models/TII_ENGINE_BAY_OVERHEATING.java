...
import APFE.guard_conditions.*;
import APFE.data_log.LogEntry;
import static APFE.guard_conditions.LogicalGuardCondition.LogicalExpression;
import java.util.logging.Level;
import java.util.logging.Logger;

public class TII_ENGINE_BAY_OVERHEATING extends WFNetOP {
  ...
  public TII_ENGINE_BAY_OVERHEATING() {
     ...
     t12.setGuardCondition(new LogicalGuardCondition
(
	Arrays.asList
		(
     ...
     t11.setGuardCondition(new TrivialGuardCondition());
     addTransition(t11);
     t14.setLabel("AND-JOIN");
     t14.setGuardCondition(new TrivialGuardCondition());
     addTransition(t14);
     t13.setLabel("CHECK:S1.1:NOT FULFILLED");
     t13.setGuardCondition(new LogicalGuardCondition
(
	Arrays.asList
		(
			new LogicalExpression("58501.07","=",0),
     ...
     t16.setGuardCondition(new LogicalGuardCondition
(
	Arrays.asList
		(
     ...
     t15.setGuardCondition(new LogicalGuardCondition
(
	Arrays.asList
		(
			new LogicalExpression("55253.02",">",70)
     ...
     t18.setGuardCondition(new LogicalGuardCondition
(
	Arrays.asList
		(
     ...
     t17.setGuardCondition(new GuardCondition() {
	@Override
	...
	public Collection<String> getInvolvedVariables() {
     ...
     t19.setGuardCondition(new LogicalGuardCondition
(
	Arrays.asList
		(
			new LogicalExpression("55254.04","=",3)
     ...
     t21.setGuardCondition(new LogicalGuardCondition
(
	Arrays.asList
		(
     ...
     t20.setGuardCondition(new LogicalGuardCondition
(
	Arrays.asList
		(
     ...
     t22.setGuardCondition(new LogicalGuardCondition
(
	Arrays.asList
		(
